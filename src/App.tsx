...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen font-sans text-slate-200">
        ...
        <main className="flex flex-col gap-32 pb-32 pt-24">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl hover:border-yellow-400/30 transition-all">
                ...
                <ul className="space-y-4">
                  {["Department of Biochemistry", "Department of Botany", "Department of Fisheries and Aquatic Biology", "Department of Microbiology", "Department of Science Laboratory Technology", "Department of Zoology and Environment Biology"].map((dept, i) => (
              ...
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl hover:border-yellow-400/30 transition-all">
                ...
                <ul className="space-y-4">
                  {["Department of Chemistry"].map((dept, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-yellow-400/50 mt-2 shrink-0" />
                      <span className="text-sm text-slate-300 font-medium">{dept}</span>
                    </li>
              ...
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl hover:border-yellow-400/30 transition-all">
                ...
                <ul className="space-y-4">
                  {["Department of Physics", "Department of Mathematics"].map((dept, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-yellow-400/50 mt-2 shrink-0" />
                      <span className="text-sm text-slate-300 font-medium">{dept}</span>
                    </li>
          ...
          <section id="vault" className="px-4 max-w-4xl mx-auto w-full">
            ...
            <div className="space-y-3">
              {['Department of Biochemistry', 'Department of Botany', 'Department of Fisheries and Aquatic Biology', 'Department of Microbiology', 'Department of Science Laboratory Technology', 'Department of Zoology and Environment Biology', 'Department of Chemistry', 'Department of Physics', 'Department of Mathematics'].map((dept, i) => {
              ...
              {vaultSearchQuery && [
                'Department of Biochemistry', 'Department of Botany', 'Department of Fisheries and Aquatic Biology', 'Department of Microbiology', 'Department of Science Laboratory Technology', 'Department of Zoology and Environment Biology', 'Department of Chemistry', 'Department of Physics', 'Department of Mathematics'
              ].every(dept => {
                const query = vaultSearchQuery.toLowerCase();
                const deptMatches = dept.toLowerCase().includes(query);
          ...
          <section id="hall-of-fame" className="px-4 max-w-7xl mx-auto w-full relative">
            ...
            {/* Clean empty state */}
            <div className="text-center py-12 px-6 bg-white/5 border border-white/10 rounded-3xl border-dashed">
              <p className="text-slate-400 text-sm">No inductees currently displayed. Add members via your Admin Panel.</p>
            </div>
          </section>
      ...
      <style>{`.font-space-grotesk { font-family: 'Space Grotesk', system-ui, sans-serif; }
        @keyframes marquee {
